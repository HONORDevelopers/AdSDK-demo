 ...
 * @since 2022-12-09
 */
public class InstallPictureTextListAdapter extends RecyclerView.Adapter<InstallPictureTextListAdapter.PictureTextListViewHolder>{
    private static final String LOG_TAG = InstallPictureTextListAdapter.class.getSimpleName();
    private List<PictureTextExpressAd> mPictureTextExpressAdList;

    public InstallPictureTextListAdapter(List<PictureTextExpressAd> mPictureTextExpressAdList) {
    ...
    public PictureTextListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View rootView = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_picture_text_install_item, null, false);
