...
public class ScreenUtils {
    ...
    public static int getStateBarHeight() {
        ...
        try {
            ...
            HiAdsLog.e(TAG, "get state bar height ex! errorMsg is " + e.getMessage());
        }
        return 0;
    }
    ...
    public static int getNavigationBarHeight(Activity activity) {
        ...
        //BHLog.i("xxx", String.format("getNavigationBarHeight: %s %s", realHeight, displayHeight));
