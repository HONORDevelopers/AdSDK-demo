...
public class BigPictureAdViewHolder extends BaseViewHolder {
    ...
    public BigPictureAdViewHolder(@NonNull View itemView) {
        super(itemView);
        adImageView = itemView.findViewById(com.hihonor.adsdk.picturetextad.R.id.ad_image);
        brandLogoView = itemView.findViewById(com.hihonor.adsdk.picturetextad.R.id.ad_brand_logo);
