...
class SmallPictureViewHolder extends PictureBaseViewHolder {
   public static final String LOG_TAG = "SmallPictureViewHolder";
   private final ImageView adImageView;

   public SmallPictureViewHolder(View mRootView) {
       super(mRootView);
