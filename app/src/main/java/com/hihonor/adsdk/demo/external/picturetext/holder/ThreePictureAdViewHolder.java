...
public class ThreePictureAdViewHolder extends BaseViewHolder {
    ...
    public void bindData(@NonNull PictureTextExpressAd baseAd) {
        ...
        // 三图根布局左padding边距
        float paddingMaxStart = context.getResources().getDimension(com.hihonor.adsdk.picturetextad.R.dimen.honor_ads_magic_dimens_max_start);
        // 三图根布局左padding边距
        float paddingMaxEnd = context.getResources().getDimension(com.hihonor.adsdk.picturetextad.R.dimen.honor_ads_magic_dimens_max_end);
